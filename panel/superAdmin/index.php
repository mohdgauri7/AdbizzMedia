...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Super Admin</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#adminLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Admin
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="adminLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                        ...
                                        <?php 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>".$row['os']."</td>
                                                    <td>".$row['geo']."</td>
                                                    <td>".$row['standardPayout']."</td>
                                                    <td>".$row['currency']."</td>
                                                    <td>".$status."</td>
                                                    <td><button class='view btn btn-sm btn-success' id=".$row['id'].">View</button> <button class='view btn btn-sm btn-success' id=ed".$row['id'].">Edit</button> <button class='view btn btn-sm btn-danger' id=dlt".$row['id'].">Delete</button></td>
                                                </tr>";
                                            } 
                                        ?>
                                    </tbody>
