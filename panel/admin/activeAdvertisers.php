                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Active Advertisers</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM `advertisers` where createdBy='$created_by' AND status='active'"; 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>".$row['email']."</td>
                                                    <td>".$row['country']."</td>
                                                    <td><a href='activeAdvertisers.php?advtId=".$row['id']."'>Change</a></td>
