...
if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["pubId"])){
    $id = $_GET['pubId'];
    $status = "active";
    $sqlUpdate = "UPDATE `publishers` SET `status` = '$status' WHERE `publishers`.`id` = $id";
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Inactive Publishers</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                            ...
                                            $sql = "SELECT * FROM `publishers` where createdBy='$createdBy' AND status='inactive'"; 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>".$row['country']."</td>
                                                    <td>".$row['postback']."</td>
                                                    <td><a href='inactivePublishers.php?pubId=".$row['id']."'>Change</a></td>
                                                    <td><a href='viewPublisher.php?publisherId=".$row['id']."'>View</a> <a href='#'>Edit</a> <a href='#'>Delete</a></td>
                                                </tr>";
                                            } 
                                        ?>
                                    </tbody>
