                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Active Publishers</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM `publishers` where createdBy='$createdBy' AND status='active'"; 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>".$row['country']."</td>
                                                    <td>".$row['postback']."</td>
                                                    <td><a href='activePublishers.php?pubId=".$row['id']."'>Change</a></td>
