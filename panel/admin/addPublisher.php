...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $api_key = substr(str_shuffle($str_result), 0, 25);
    ...
    $pubTier = $_POST["pubTier"];
    $connectedThrough = $_POST["connectedThrough"];
    $postback_status = $_POST["postback_status"];
    $cut_back = $_POST["cut_back"];
    ...
    if($num > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `publishers` ( `name`, `email`, `skypeId`, `api_key`, `number`, `country`, `website`, `postback`, `eventPostback`, `pubTier`, `connectedThrough`, `password`, `createdBy`, `cut_back`, `current_postback_ind`, `postback_status`, `status`, `dt`) VALUES ('$name', '$email', '$skypeId', '$api_key', '$number', '$country', '$website', '$postback', '$evpostback', '$pubTier', '$connectedThrough', '$hash', '$creatingBy', '$cut_back', 0, '$postback_status', 'active', current_timestamp())";
            $result = mysqli_query($conn, $sql);
            if ($result){
                $showAlert = true;
            }else{
                                    ...
                                    <div class="card-body">
                                        <form action="addPublisher.php" method="post">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <select class="form-control form-control-md" name="pubTier">
                                                            <option value=""> -- Publisher Tier* -- </option>
                                                            <option value="standerd">Standerd</option>
                                                            <option value="premium">Premium</option>
                                                            <option value="senditive">Sensitive</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <select class="form-control form-control-md" name="connectedThrough">
                                                            <option value=""> -- Connected Through* -- </option>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <select class="form-control form-control-md" name="postback_status">
                                                            <option value="active">Postback Active</option>
                                                            <option value="inactive">Postback Inactive</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <select class="form-control form-control-md" name="cut_back">
                                                            <option value="0"> -- Cut Back -- </option>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" type="submit">Add Publisher</button></div>
                                            </div>
