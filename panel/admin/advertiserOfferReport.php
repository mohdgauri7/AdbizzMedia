            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Offers Report</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Advertiser Offer Report</li>
                        </ol>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT * FROM `campaigns` where advertiserId='$advtId'"; 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                $advtRevenue = $advtRevenue + ($numConversion * $row['revenue']);

                                                $advtPayout = $advtPayout + ($numConversion * $row['standardPayout']);
