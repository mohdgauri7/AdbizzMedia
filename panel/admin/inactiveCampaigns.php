...
if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["campId"])){
    $id = $_GET['campId'];
    $status = "active";
    $sqlUpdate = "UPDATE `campaigns` SET `status` = '$status' WHERE `campaigns`.`id` = $id";
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Inactive Campaigns</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                            ...
                                            $sql = "SELECT * FROM `campaigns` where createdBy='$created_by' AND status='inactive'"; 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>".$row['landingUrl']."</td>
                                                    <td>".$row['os']."</td>
                                                    <td>".$row['geo']."</td>
                                                    <td>".$row['standardPayout']."</td>
                                                    <td>".$row['currency']."</td>
                                                    <td><a href='inactiveCampaigns.php?campId=".$row['id']."'>Change</a></td>
                                                    <td><a href='viewCampaign.php?campaignId=".$row['id']."'>View</a> <a href='#'>Edit</a> <a href='copyCampaign.php?campId=".$row['id']."' target='_blank'> Copy </a> <a href='#'> Delete</a> </td>
                                                </tr>";
                                            } 
                                        ?>
                                    </tbody>
