                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                if($num == 1){
                                                    ...
                                                    echo "<tr>
                                                        ...
                                                        <td>https://adfliks.com/publisher/tracking.php?aff_id=".$pubId."&offer_id=".$campId."&aff_sub={click_id}&aff_sub2={affiliate_id}&gaid={google_id}&ifaid={ifa_id}&device_id={device_id}&sub1={app name}</td>
                                                        <td>".$row2['os']."</td>
                                                        <td>".$row2['geo']."</td>
