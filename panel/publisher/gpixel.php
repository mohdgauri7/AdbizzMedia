...
if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["click_id"]) ){
    ...
    if ($num == 1){
        ...
        if($sub_pub_id == "testoffer"){
            ...
            $sql3 = "INSERT INTO `publisher_global_conversions` (`id`, `pub_id`, `pubType`, `camp_id`, `advertiserId`, `campName`, `revenue`, `standardPayout`, `premiumPayout`, `sensitivePayout`, `currency`, `click_id`, `aff_sub2`, `gaid`, `ifaid`, `device_id`, `sub1`, `dt`) VALUES (NULL, '$pub_id', '$pubType', '$camp_id', '$advertiserId', '$campName', '$revenue', '$standardPayout', '$premiumPayout', '$sensitivePayout', '$currency', '$click_id', '$sub_pub_id', '$gaid', '$ifaid', '$device_id', '$appName', current_timestamp())";
